...
I've included additional snapshot tests (`test-text_logo.R`) in the [`A.E-mocks-snapshots` branch of `moviesApp`](https://github.com/mjfrigaard/moviesApp/tree/A.E-mocks-snapshots): 
