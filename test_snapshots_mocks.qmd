...
I've included additional snapshot tests (`test-text_logo.R`) in the [`A.E-mocks-snapshots` branch of `shinyrPkgs`](https://github.com/mjfrigaard/shinyrPkgs/tree/A.E-mocks-snapshots): 
