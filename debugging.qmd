...
The contents of a Shiny app-package can quickly become complex and intertwined (utility functions, modules, UI and server functions, data, etc.). During regular development, Posit Workbench's interactive debugger lets us inspect variables and expressions *at runtime* and execute code line-by-line. 
...
!['Print' in `movies_app()`](images/debug_print_movies_app_05.png){#fig-debug_print_movies_app_05 width='100%' align='center'}
...
The Shiny documentation also has a [list of methods](https://shiny.posit.co/r/articles/improve/debugging/) for debugging shiny applications, and learning how to read call stacks (or a stacktrace) will help you debug your shiny app.[^debug-call-stacks]
