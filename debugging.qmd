...
#| eval: false 
#| code-fold: false
debug at shinyAppPkg/R/mod_scatter_display.R#68: 
  plot <- scatter_plot(
    df = movies, 
    x_var = inputs()$x, 
    y_var = inputs()$y, 
...
debugging in: 
  scatter_plot(df = movies, 
    ...
    alpha_var = inputs()$alpha, 
    size_var = inputs()$size)
debug at /shinyAppPkg/R/scatter_plot.R#30: # <1> 
{   
...
In [`mod_var_input`](https://github.com/mjfrigaard/shinyAppPkg/blob/spec_topic-debugging-04/R/mod_var_input.R): 
...
In the `bslib` portion of [`movies_ui()`](https://github.com/mjfrigaard/shinyAppPkg/blob/spec_topic-debugging-04/R/movies_ui.R): 
...
In [`movies_server()`](https://github.com/mjfrigaard/shinyAppPkg/blob/spec_topic-debugging-04/R/movies_server.R):
