...
flowchart TD
    ...
    style DESC fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style Data fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style Global fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style Lazy fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style LazyData fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style app_data fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style load_data fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style app_data_lazy fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style load fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:1px
    style inst fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:1px
...
#' 
#' @description Single-paragraph describing [data]
#' 
...
For data documentation patterns, see [`dplyr`'s approach](https://github.com/tidyverse/dplyr/tree/main/data-raw): store data in `data/`, document with `data-*.R` files in `R/`, use `@rdname` to group related datasets, and `@format NULL` for auxiliary objects. 
