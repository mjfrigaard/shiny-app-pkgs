...
flowchart
  AddLazyData("<code>LazyData: true</code>
              to <code>DESCRIPTION</code>")
  LoadAll("Run <code>load_all()</code>")
  Document("Run <code>document()</code>")
  Install("Run <code>install()</code>")
  UpdateNamespace("Update <code>NAMESPACE</code> 
                   with <code>LazyData</code>")
  BuildBinary("Build package binary")
  LoadData("Load data into 
            <code>NAMESPACE</code>")
...
### [`\describe`]{style="font-size: 1.0em;"} & [`\item`]{style="font-size: 1.0em;"}
...
## The [`data-raw/`]{style="font-size: 1.0em; font-weight: bold;"} folder {#sec-data-data-raw}
