...
The installed folders and files can be viewed using the file path accessor function, `system.file()`. 
...
::: {#fig-data_data_help}
![The `movies` help file](images/data_data_help.png){#fig-09_data_rd width='85%' fig-align='center'}
