...
The diagram below captures what happens to the package files and namespace after adding `LazyData: true` to the `DESCRIPTION` file and exporting `movies` from `moviesApp`.
...
The figure below captures what happens to the moviesApp package files after creating the `R/data.R` file. 
