...
[Introduction](intro.qmd) covers the development of a Shiny app project and it's gradual progression of complexity to warrant an R package:
...
The [app-packages](app_packages.qmd) applies the key components of R package development to a Shiny app. These sections aren't likely to change anytime soon.
