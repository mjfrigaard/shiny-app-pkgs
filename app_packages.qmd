...
4. [`06_create-package`](https://github.com/mjfrigaard/moviesApp/tree/06_create-package) is a branch from `03_proj-app` and creates a package using `usethis::create_package()`
...
1. [`06_devtools`](https://github.com/mjfrigaard/moviesApp/tree/06_devtools) is a branch from the manually converted app-package in [`05_rproj`](https://github.com/mjfrigaard/moviesApp/tree/05_rproj)
...
co_box(
  ...
  header = "`moviesApp/tree/main`",
  contents = "
  
The code for the next section can be found in the [`moviesApp`](https://github.com/mjfrigaard/moviesApp/tree/main) repository.
  
The [`main`](https://github.com/mjfrigaard/moviesApp/tree/main) branch of `moviesApp` is identical to the [`06_create-package`](https://github.com/mjfrigaard/moviesApp/tree/06_create-package) branch from the `moviesApp` repository from the previous section:
...
[Tests](tests.qmd) introduces the [BDD](https://testthat.r-lib.org/reference/describe.html) functions and how to 'scope' the tests in your app-package before writing any code. 
