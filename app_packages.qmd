...
The [Shiny](shiny.qmd) Chapter coveres Shiny projects (@sec-shiny-projects) and some 'pre-package practices' (@sec-adv-shiny-projects) to adopt in your Shiny app that can make the transition to working with app-packages easier. 
