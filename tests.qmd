...
However, if you downloaded or cloned the [`monthApp`](https://github.com/hadley/monthApp) example from the [Modules chapter](https://mastering-shiny.org/scaling-modules.html), then clicked on **Test** in the **Build** pane, you saw the following:
