...
co_box(
  color = "o",
  header = "Disclaimer", fold = FALSE, look = "simple",
  contents = "
...
co_box(
  color = "r",
  fold = FALSE,
  header = "GitHub [`pkgApp`]:[`06-tests`]",
  contents = "
  
  This shiny app project can be found in the `06-tests` branch of the [`pkgApp`](https://github.com/mjfrigaard/pkgApp/tree/06-tests) repo.
...
The fourth `devtools` [habit]{style="font-weight: bold; font-size: 1.0em; color: #772953"} we want to adopt is regularly writing and running tests. We can test our package using the **Build** pane or the keyboard shortcut:
