...
## [Debuggers (Chapter 10)]{style='font-size: 1.35em;'}
...
## [Print debugging (Chapter 11)]{style='font-size: 1.35em;'}
...
## [Debugging apps (Chapter 12)]{style='font-size: 1.35em;'}
...
## [Logging (Chapter 13)]{style='font-size: 1.35em;'}
...
1. Combining `system.file()` (@sec-external-system-file) and `addResourcePath()` (@sec-resources-add-resource-path), and  

2. The various uses of the `inst/` folder (@sec-resources)
<br>
    a. Alternative images and layout options (@sec-external-system-file)
<br><br>
    b. Development versions of your application using alternative data and modules (@sec-resources-inst-tidy-movies-app)
<br><br>
