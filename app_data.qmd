...
Calling `reactiveValues()` will create *"an object for storing reactive values."* Determining whether or not to use `reactiveValues()` will depend on the purpose you want it to serve in your application. [^reactive-values-intro]
