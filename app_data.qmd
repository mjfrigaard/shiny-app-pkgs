...
[^view-reactive-values-test]: You can view the full `test-mod_scatter_display.R` test file in the [`24.1.4_step_04`](https://github.com/mjfrigaard/shinyrPkgs/tree/24.1.4_step_04) branch.
...
devServer <- function(input, output, session) {
  ...
  rVals$inputs <- shinyrPkgs::mod_var_input_server("vars", # <3>
                                                  .dev = TRUE) # <3>
