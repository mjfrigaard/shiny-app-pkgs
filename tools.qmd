...
## LLM concepts {#sec-tools-llm-concepts}
...
### Context Windows {#sec-tools-context-windows}
...
flowchart LR
    ...
    classDef root fill:#4CBB9D,stroke:#2d8a7a,stroke-width:3px,color:#fff
    classDef negative fill:#333,stroke:#000,stroke-width:2px,color:#fff
    classDef positive fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff
    classDef detail fill:#e8f4f1,stroke:#4CBB9D,stroke-width:1px,color:#000
...
flowchart TD
    ...
    style Chatbot fill:#e8f4f1,stroke-width:3px,stroke:#4CBB9D
    style UserCB fill:#4CBB9D,stroke:#2d8a7a,stroke-width:1px,color:#fff
    style LlmCB fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style ReplyCB fill:#4CBB9D,stroke:#2d8a7a,stroke-width:1px,color:#fff
...
flowchart TD
    ...
    style Agent fill:#e8f4f1,stroke-width:3px,stroke:#4CBB9D
    style UserAg fill:#4CBB9D,stroke:#2d8a7a,stroke-width:1px,color:#fff
    style LlmAg fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style Decide fill:#4CBB9D,stroke:#2d8a7a,stroke-width:2px,color:#fff
    style FinalAg fill:#4CBB9D,stroke:#2d8a7a,stroke-width:1px,color:#fff
    style ToolCall fill:#333,stroke:#000,stroke-width:1px,color:#fff
    style Observe fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
```
