...
## What happened to our icon image? {.unnumbered}
...
### Our app-package ... *installed* {.unnumbered}
...
## External resources {#sec-external-system-file}
...
## Apps in [`inst/`]{style="font-size: 1.05em;"} {.unnumbered} 
...
## Production ([`prod`)]{style="font-size: 0.95em;"} versions {#sec-external-inst-prod}
