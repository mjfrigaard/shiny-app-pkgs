...
!['Source' files `shinyAppPkg` in **Files** pane](img/10_inst_files_pane.png)

!['Source' files `shinyAppPkg` in **Finder** (macOS)](img/10_inst_finder_pkg.png)
...
In `inst/dev/`, we've placed the application modules in an [`app.R` file](https://github.com/mjfrigaard/shinyAppPkg/blob/09c_inst-dev/inst/dev/app.R):
