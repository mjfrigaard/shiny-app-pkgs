...
## Image files {#sec-external-add-resources}
...
## Data files {#sec-external-inst-dev}
...
### Launching [`tidy-movies`]{style="font-size: 0.95em;"} {#sec-inst-tidy-movies-launch}
...
## Quarto apps {#sec-external-inst-quarto}
...
## Production {#sec-external-inst-prod}
...
### [Deploying `inst/prod/`]{style="font-size: 0.95em;"} {#sec-inst-prod-deploy}
