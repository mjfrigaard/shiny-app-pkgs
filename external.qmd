...
- **`system.file()`**: the `system.file()` function is a 'file path accessor function'\n
...
#### [New `www` location]{style="font-size: 0.95em;"} {#sec-external-inst-www}
...
## App versions with [`inst/`]{style="font-size: 1.05em;"} {#sec-inst-apps} 
...
### Alternate UI layouts with [`bslib`]{style="font-size: 0.95em;"} {#sec-external-inst-bslib}
...
```{r}
#| label: git_launch_09b_inst-bslib
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
### Alternate data in [`dev/`]{style="font-size: 0.95em;"} {#sec-external-inst-dev}
...
#### Launch [`inst/dev/`]{style="font-size: 0.95em;"} {#sec-inst-dev-launch}
...
### [`prod/` versions]{style="font-size: 0.95em;"} {#sec-external-inst-prod}
...
#### [Deploying `inst/prod/app/`]{style="font-size: 0.95em;"} {#sec-inst-prod-deploy}
