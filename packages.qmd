...
Below are folder trees with some of the typical files and folders found in [**R packages**]{style='color: #ad343e;'} (on the left) and the files that currently exist in `shinyAppProj` (on the right), our [**shiny app project**]{style='color: #00916e;'}. 
