...
There are multiple reasons for deciding to develop a Shiny [app-package]{style="font-weight: bold; color: #00a6ed"}, but if you're reading this book, you've likely found yourself in one of two circumstances:
...
The previous chapter covered a few practices to adopt during Shiny development that improve the extensibility of your Shiny app [project]{style="font-weight: bold; color: #00916e"} and make it easier to convert into a Shiny [app-package]{style="font-weight: bold; color: #00a6ed"}.[^pkgs-shiny-development]
...
#| eval: true
co_box(
  color = "b", fold = TRUE, look = 'default', 
...
R [packages]{style='font-weight: bold; color: #ad343e;'} can be easily shared, reused, and reproduced because they all have a familiar structure, and each folder and file plays an essential role in extending R’s capabilities.[^pkgs-folder-trees]
...
[^pkgs-folder-trees]: Fortunately, Shiny [app-packages]{style="font-weight: bold; color: #00a6ed;"} don't require *all* the files and folders displayed in the folder tree to gain the functionality and benefits of an R [package]{style='font-weight: bold; color: #ad343e;'}. 
...
- [x] created a Shiny app [project]{style='font-weight: bold; color: #00916e;'} (`moviesApp`) 

- [x] with a `DESCRIPTION` file 

- [x] and an `R/` directory

So, is `moviesApp` a functioning R [package]{style='font-weight: bold; color: #ad343e;'}? 
...
Functioning R [packages]{style='font-weight: bold; color: #ad343e;'} also have access to the **Build** pane, which allows us to quickly load, install, and test code.
...
As we've just learned, the presence of the `DESCRIPTION` file and an `R/` folder are insufficient to turn a Shiny app [project]{style='font-weight: bold; color: #00916e;'} into a *functioning* R [package]{style='font-weight: bold; color: #ad343e;'} that can be installed and loaded into an R session *and* has access to the **Build** pane in the IDE.

## *Functional* R [packages]{style='font-weight: bold; color: #ad343e;'} {#sec-packages-essential-ingredients}
...
When the new session starts, the new project-level options activate the **Build** pane in the IDE, and I can check the R [package]{style='font-weight: bold; color: #ad343e;'} functionality by loading the code with **Build** > **Load All**
...
## R [packages]{style='font-weight: bold; color: #ad343e;'} Recap
...
```{r}
#| label: git_box_06a_create-package
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
  fig_pw = '75%', 
  branch = "03c_create-package", 
  repo = 'moviesApp')
```
...
If you already have a Shiny app [project]{style='font-weight: bold; color: #00916e;'} that needs to be converted into a Shiny [app-package]{style="font-weight: bold; color: #00a6ed;"} (like the app files stored in the [`02b_proj-app` branch](https://github.com/mjfrigaard/moviesApp/tree/02b_proj-app)), you can also use `create_package(path = getwd())` in your root folder, but I recommend using the following arguments:
