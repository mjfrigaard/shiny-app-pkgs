...
-  **Shiny Projects** ![](images/rproj_icon.png){height=30} 
...
Shiny app-packages![](images/shinyap_small_v2.png){height=30} have all of the functionality of a standard R Package![](images/rpkg_small_v2.png){height=30} but also contain the files and folders required to successfully develop, run, and deploy a Shiny app. There are multiple reasons for deciding to develop a Shiny app-package, but if you're reading this book, you've likely found yourself in one of two circumstances:

1. You want to develop a new app, but want it structured as an R package![](images/rpkg_small_v2.png){height=30}.  

2. You've already developed a Shiny app project![](images/rproj_icon.png){height=30}, but now you need to convert it into an R package![](images/rpkg_small_v2.png){height=30}
...
## R packages ![](images/rpkg_small_v2.png){height=20}
...
So, is `sap` a functioning R package? We can test this with the following:
...
### RStudio's Build pane ![](images/rstudio-icon.png){height=20}
...
### Positron's workspaces ![](images/positron.png){height=20}
...
As we've just learned, the presence of the `DESCRIPTION` file and an `R/` folder are insufficient to turn a Shiny app project into a 'functioning' R package that can be installed and loaded into an R session. In a functional app-package ![](images/shinyap_small_v2.png){height=30}: 
...
## App-packages ![](images/shinyap_small_v2.png){height=20}
