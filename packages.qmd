...
co_box(
  ...
  header = "TLDR R packages  &emsp; ![](images/rpkg_icon_v2.png){width='12%'}", 
  fold = TRUE,
  contents = "
...
-   ![](images/rproj_icon.png){height=35} **Shiny Projects**
    ...
    -   Shiny projects also include an Posit workbench project file (`.Rproj`)  

-   ![](images/rpkg_small_v2.png){height=35} **R Packages**

    -   I'll use the term **R package** to describe a directory of functions, documentation, or data that can be installed and loaded into an R session    
