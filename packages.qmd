...
![](images/pkgs_r_pkg.png){fig-align="right"}
...
co_box(
  ...
  header = "![](images/00_index_pkg.png){width='9%'} &emsp; TLDR", 
  fold = TRUE,
  contents = "
...
### Converting existing Shiny [projects]{style="font-weight: bold; color: #00916e"}
...
```{r}
#| label: git_box_moviesApp_06_create-package
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
