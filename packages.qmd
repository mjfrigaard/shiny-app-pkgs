...
I'll use color to differentiate shiny app [projects]{style="font-weight: bold; color: #25a18e"}, R [packages]{style='font-weight: bold; color: #720026;'}, and [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}.

:::

-   [Project]{style="font-weight: bold; color: #25a18e"}: I consider a [project]{style="font-weight: bold; color: #25a18e"} to be any directory of files requiring R (the binary downloaded from [CRAN](https://cran.r-project.org/) with a version number and neat names like, '*R 4.3.1 "Beagle Scouts" released on ...*') to execute with an RStudio/Posit workbench project file (`.Rproj`).

-   [Package]{style='font-weight: bold; color: #720026;'}: I'll be using the term [package]{style='font-weight: bold; color: #720026;'} to describe a directory of functions, documentation, or data that can be installed and loaded into an R session. A [package]{style='font-weight: bold; color: #720026;'} includes the necessary dependency management (`NAMESPACE`) and metadata files (`DESCRIPTION`) *and* has access to the package development tools in RStudio/Posit Workbench.

-   [App]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}: an [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"} (which you have probably already guessed) is a [package]{style='font-weight: bold; color: #720026;'} containing a shiny application. [App]{style="font-weight: bold; color: #007bff"}-[packages]{style="font-weight: bold; color: #720026"} have all of the functionality of a standard R [package]{style='font-weight: bold; color: #720026;'}, but also contain the files and folders required to successfully develop, run, and deploy a shiny [app]{style="font-weight: bold; color: #007bff"}.
...
Posit Workbench (formerly RStudio) is a popular integrated development environment (IDE) streamlining many R [package]{style='font-weight: bold; color: #720026;'} development tasks. I’ve purposely connected Posit Workbench to the definitions above for [package]{style='font-weight: bold; color: #720026;'} and [app]{style='font-weight: bold; color: #007bff'}-[package]{style='font-weight: bold; color: #720026;'}–specifically, the [package]{style='font-weight: bold; color: #720026;'} development tools provided in the Build pane and devtools.

However, developing R [packages]{style='font-weight: bold; color: #720026;'} in Posit Workbench (or using `.Rproj` files) is not required. There are alternative [package]{style='font-weight: bold; color: #720026;'} development tools and processes outside of Posit Workbench, and many developers employ these setups.

[Package]{style='font-weight: bold; color: #720026;'} development outside Posit Workbench would look almost identical to development in the IDE:

1. Create the [package]{style='font-weight: bold; color: #720026;'} structure (`R/` folder for `.R` scripts, `man/` folder for documentation, `data/` folder for datasets, etc.)
  
2. Add `DESCRIPTION` and `NAMESPACE` files, etc.
  
3. Ensure the [package]{style='font-weight: bold; color: #720026;'} can be installed and loaded into an R session.
...
The previous chapter covered a few practices to adopt during shiny development that improves the extensibility of your app [project]{style="font-weight: bold; color: #25a18e"} to an [app]{style='font-weight: bold; color: #007bff;'}-[package]{style='font-weight: bold; color: #720026;'} (these are summarized in the callout box below).
...
## [App]{style='font-weight: bold; color: #007bff'}-[packages]{style='font-weight: bold; color: #720026'}: Motivation

There are multiple reasons for deciding to develop an [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}: your app [project]{style="font-weight: bold; color: #25a18e"} might have to be in a [package]{style='font-weight: bold; color: #720026;'} structure due to specific organizational needs or practices around deploying applications, or maybe you've been convinced it's the best practice for improving the shareability/reproducibility of your app [project]{style="font-weight: bold; color: #25a18e"}. 

Regardless of the reason, you've likely found yourself in one of two circumstances:

1. You want to develop a new shiny app, but want it structured as an [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}.  

2. You've already developed a shiny app [project]{style="font-weight: bold; color: #25a18e"}, but now you need to convert it to an [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}.

### R [package]{style='font-weight: bold; color: #720026;'} vs. shiny [project]{style="font-weight: bold; color: #25a18e"}

Below is a folder tree with some of the typical files and folders found in R [packages]{style='font-weight: bold; color: #720026;'}:
...
R [packages]{style='font-weight: bold; color: #720026;'} can be easily shared, reused, and reproduced because they all have a familiar structure, and each folder and file plays an essential role in extending R’s capabilities.

At first glance, the contents above can seem daunting when compared to the folders and files that currently exist in your app [project]{style='font-weight: bold; color: #25a18e;'} (like `projApp` below): 
...
Fortunately, [app]{style='font-weight: bold; color: #007bff;'}-[packages]{style='font-weight: bold; color: #720026;'} don't require *all* the files and folders displayed above to gain the functionality and benefits of an R [package]{style='font-weight: bold; color: #720026;'}. 

This chapter will cover what's required in all R [packages]{style='font-weight: bold; color: #720026;'}, so you can handle both creating new [app]{style='font-weight: bold; color: #007bff;'}-[package]{style='font-weight: bold; color: #720026;'} and converting existing shiny [projects]{style="font-weight: bold; color: #25a18e"} into [app]{style='font-weight: bold; color: #007bff;'}-[package]{style='font-weight: bold; color: #720026;'}.

## What makes an R [package]{style='font-weight: bold; color: #720026;'}?
...
If you've been following the code in `projApp`, the quotes above should confuse you. The `projApp` shiny [project]{style='font-weight: bold; color: #25a18e;'} has a `DESCRIPTION` file and an `R/` directory, but `projApp` is not a functioning [package]{style='font-weight: bold; color: #720026;'}. 

As we defined above, a functioning [package]{style='font-weight: bold; color: #720026;'} can be installed and loaded into an R session *and* has access to the **Build** pane in the IDE.
...
When opened, functioning [packages]{style='font-weight: bold; color: #720026;'} have access to the **Build** pane, which allows us to iterate between loading, installing, and testing quickly. But when `projApp` is opened, the **Build** pane is not displayed in the IDE:
...
As we've just learned, the presence of the `DESCRIPTION` file and an `R/` folder are insufficient to turn your app [project]{style='font-weight: bold; color: #25a18e;'} into a [package]{style='font-weight: bold; color: #720026;'} (or an [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}).

## What *really* makes an R [package]{style='font-weight: bold; color: #720026;'}?

For our purposes, I'll rewrite the minimum requirements for creating a 'functional' R [package]{style='font-weight: bold; color: #720026;'}:

> "*A [project]{style="font-weight: bold; color: #25a18e"} needs **a `DESCRIPTION` file with specific fields**, a directory of `R/` files, and **a properly configured `.Rproj` file** to be a [package]{style='font-weight: bold; color: #720026;'}.*" - Me

Let's see how each of these requirements works together to convert the contents of `projApp` from a [project]{style="font-weight: bold; color: #25a18e"} into a [package]{style='font-weight: bold; color: #720026;'}.

### [`DESCRIPTION`]{style="font-size: 0.95em"} fields

The [official R documentation](https://cran.r-project.org/doc/manuals/r-release/R-exts.html#The-DESCRIPTION-file) lists the following required fields for the `DESCRIPTION` in R [packages]{style='font-weight: bold; color: #720026;'}:
...
### [Project]{style="font-weight: bold; color: #25a18e"} options 
...
#### Default [project]{style="font-weight: bold; color: #25a18e"} options

**Tools** > **Project options** provide access to the [project]{style="font-weight: bold; color: #25a18e"}-level options. For example, fields 2 - 4 are available under **General**, 5 - 8 affect the **Code** options, and the final two fields deal with **Sweave**. 
...
These are the default settings created when we selected the Shiny App [project]{style='font-weight: bold; color: #25a18e;'} from the **New Project Wizard** in the last chapter.
...
I've circled the fields in the [R Packages, 2ed](https://r-pkgs.org/workflow101.html#what-makes-an-rstudio-project) `.Rproj` file that illustrate it's configured to work with a [package]{style='font-weight: bold; color: #720026'}. Note that in `projApp`, the **Project build tools** are initially set to (**None**) under **Build Tools**:
...
This setting should help explain the absence of any [package]{style='font-weight: bold; color: #720026;'} development fields in the `projApp.Rproj` when we compared it to the version in [R Packages, 2ed](https://r-pkgs.org/workflow101.html#what-makes-an-rstudio-project) (i.e., `BuildType`, `PackageUseDevtools`, `PackageInstallArgs`, and `PackageRoxygenize`). 
...
-   `BuildType: Package` tells the IDE `projApp` is a [package]{style='font-weight: bold; color: #720026;'} and triggers the **Build** pane.
...
-   The fourth option (`PackageRoxygenize`) is available under **Generate documentation with Roxygen** > **Use roxygen to generate**
    -   These options affect the documentation in your [package]{style='font-weight: bold; color: #720026;'}. To match the example from [R Packages, 2ed](https://r-pkgs.org/workflow101.html#what-makes-an-rstudio-project) above, make sure **Rd files**, **Collate field**, and **NAMESPACE file** are selected and click **OK**.
...
When the new session starts, the new [project]{style="font-weight: bold; color: #25a18e"}-level options activate the **Build** pane in the IDE. 
...
When the IDE reboots, I can see the **Build** pane has been added, and I can check the [package]{style='font-weight: bold; color: #720026;'} functionality by loading the code with **Build** > **Load All**
...
There you have it--`projApp` is a functional [package]{style="font-weight: bold; color: #720026"}!

## Functional R [packages]{style='font-weight: bold; color: #720026;'}
...
A functional R [package]{style='font-weight: bold; color: #720026;'}: 
...
The items above will create a functional R [package]{style='font-weight: bold; color: #720026;'}, but these are the first steps (we haven't developed anything yet!) on our way to an [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}.
...
The [Posit documentation](https://docs.posit.co/ide/user/ide/guide/pkg-devel/writing-packages.html) lists the following ways to create R [packages]{style='font-weight: bold; color: #720026;'}, 
...
While this information isn't incorrect, we just demonstrated it's possible to create a [package]{style='font-weight: bold; color: #720026;'} without the `usethis::create_package()` function. Still, if you're looking for a way to quickly create or convert your app [project]{style="font-weight: bold; color: #25a18e"} into an [app-package]{style='font-weight: bold; color: #007bff;'}, using `create_package()` is a great option. 
...
If you want to create a new shiny [app-package]{style='font-weight: bold; color: #007bff;'}, but haven’t written any code, you can create it with the `create_package()` function from the [`usethis` package](https://usethis.r-lib.org/reference/create_package.html).
...
Assuming your current working directory is where you want your new [app-package]{style='font-weight: bold; color: #007bff;'}, call `usethis::create_package()` with the `path` argument set to `getwd()`
...
You're now free to develop `newApp`. Store and document any `.R` files in the `R/` folder, edit the `DESCRIPTION` file with details about the application, read through  [R Packages](https://r-pkgs.org/) and [Mastering Shiny](https://mastering-shiny.org/), and add the shiny code to complete your [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"}

### Converting existing app

If you already have a shiny app [project]{style='font-weight: bold; color: #25a18e'} that needs to be converted into an [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"} (like the app files stored in the [`03_projApp` branch](https://github.com/mjfrigaard/projApp/tree/03_projApp)), you can also use `create_package(path = getwd())` in your root folder, but I recommend using the following arguments:
...
-   Two additional arguments from `use_description()` are passed to `create_package()`:
    ...
    -   **`check_name`**: verifies your [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"} name is valid for CRAN, so we can set this to `FALSE` (unless you're planning on submitting to CRAN)
...
When converting your existing shiny app [project]{style='font-weight: bold; color: #25a18e'} into am [app]{style='font-weight: bold; color: #007bff'}-[package]{style='font-weight: bold; color: #720026'} with `usethis::create_package()`, don't use `'.'` in the `path` argument:
  
`\`\`\r
usethis::create_package('.')
`\`\`\
  
This will return the following warning about creating nested [projects]{style='font-weight: bold; color: #25a18e'}, and ask if you want to proceed anyway:
...
We can avoid this warning altogether by passing the `getwd()` to the `path` argument, so I recommend cancelling the [project]{style='font-weight: bold; color: #25a18e'} creation:
...
The [app]{style="font-weight: bold; color: #007bff"}-[package]{style="font-weight: bold; color: #720026"} structure is below:
...
This chapter has covered the mandatory fields in the `DESCRIPTION` file and the [package]{style='font-weight: bold; color: #720026;'} configuration fields in `.Rproj`. We also covered creating and converting [projects]{style='font-weight: bold; color: #25a18e'} using the `usethis::create_package()` function.
...
-   **The `DESCRIPTION` file** ultimately controls whether you have a functional shiny [package]{style='font-weight: bold; color: #720026;'}.
    -   The mandatory fields are `Package`, `Version`, `License`, `Description`, `Title`, `Author`, and `Maintainer`.

-   `usethis::create_package()` can be used to create a new [package]{style='font-weight: bold; color: #720026;'} and to convert an existing shiny [project]{style='font-weight: bold; color: #25a18e;'} into a shiny [app]{style='font-weight: bold; color: #007bff'}-[package]{style='font-weight: bold; color: #720026'}.

-   The IDE reads RStudio (`.Rproj`) files and determines R session settings at the [project]{style='font-weight: bold; color: #25a18e;'}-level (i.e., working directory, workspace, history, code formatting, etc.)

    -   [Package]{style='font-weight: bold; color: #720026;'} development settings can be accessed via **Project Options** > **Build Tools**.
