...
-  **Shiny Projects** ![](images/00_index_shiny.png){height=40}
...
-  **R Packages** ![](images/rpkg_small_v2.png){height=40} 
...
-  **Shiny app-packages** ![](images/shinyap_small_v2.png){height=40} 
...
## R packages ![](images/rpkg_small_v2.png){height=40} {#sec-packages-r-pkgs}
...
### RStudio's Build pane ![](images/rstudio-icon.png){height=30} {#sec-packages-rstudio-build-pane}
...
### Positron's workspaces ![](images/positron.png){height=40} {#sec-packages-positron-workspaces}
...
2.   If we're using RStudio, the `.Rproj` file must contain the three package configuration fields, which makes the **Build** pane accessible and functional.[^pkg-config-fields]
...
co_box(
  color = "g", 
  look = "default", hsize = "1.05", size = "0.95", 
  header = "R Package Development Cheatsheet", 
  fold = TRUE,
  contents = "Posit has an excellent '**Package Development :: Cheatsheet**' that provides a quick summary of the essentials of R package development.
...
## App-packages ![](images/shinyap_small_v2.png){height=40} {#sec-packages-app-pkgs}
