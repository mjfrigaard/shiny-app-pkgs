...
The `roxygen2` documentation for `check_installed()` uses the `@importFrom` tag to import `is_installed` and add it to the `moviesApp` namespace (using explicit namespacing along won't work):
