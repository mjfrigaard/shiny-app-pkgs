...
co_box(
  ...
  header = "Mocking",
  contents = "
Test mocks are covered in [Mocks and snapshots](test_snapshots_mocks.qmd), because the example isn't from our app-package (it comes from the package development masterclass given at [posit::conf(2023)](https://github.com/posit-conf-2023/pkg-dev-masterclass)). 
"
)
```
