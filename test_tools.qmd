...
#| code-fold: false
testthat::describe( # <1>
  "F1.3/1.5: Dropdown menus (continuous x & y axes, categorical point coloration)", # <1>
  code = { 
...
testthat::it(# <2>
  ...
  ", code = { # <2>
    ...
    test_logger(start = "T2", msg = "Tests FR1.3/1.5 initial x/y/z") # <3>
    ...
    test_logger(end = "T2", msg = "Tests FR1.3/1.5 initial x/y/z")  # <6>
  ...
  ", code = { # <7>
    ...
    test_logger(start = "T3", msg = "Tests FR1.3/1.5 update x/y/z") # <8>
    ...
    test_logger(end = "T3", msg = "Tests FR1.3/1.5 update x/y/z")  # <11>
...
INFO [2023-10-12 07:24:39] [ START T2 = Tests FR1.3/1.5 initial x/y/z]
[ FAIL 0 | WARN 0 | SKIP 0 | PASS 1 ]
INFO [2023-10-12 07:24:40] [ END T2 = Tests FR1.3/1.5 initial x/y/z]

INFO [2023-10-12 07:24:40] [ START T3 = Tests FR1.3/1.5 update x/y/z]
[ FAIL 0 | WARN 0 | SKIP 0 | PASS 2 ]
INFO [2023-10-12 07:24:40] [ END T3 = Tests FR1.3/1.5 update x/y/z]
```
