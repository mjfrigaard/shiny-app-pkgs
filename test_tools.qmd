...
testthat::it(# <2>
  ...
  ", code = { # <2>
    ...
    test_logger(start = "T2", msg = "Tests F1.2 initial x/y/z variables") # <3>
    ...
    test_logger(end = "T2", msg = "Tests F1.2 initial x/y/z variables")  # <6>
  ...
  ", code = { # <7>
    ...
    test_logger(start = "T3", msg = "Tests FR1.4 & FR1.5 update x/y/z") # <8>
    ...
    test_logger(end = "T3", msg = "Tests FR1.4 & FR1.5 update x/y/z")  # <11>
...
### Example: mocking functions

Assume I've converted the data manipulation steps for creating a tidy `ggplot2movies::movies` dataset into two functions (one using `base` R, the other using `tidyverse` functions).
