...
I recommend using the [`ensure` package](https://simonpcouch.github.io/ensure/) to help write tests in your app-package. If you're already using LLMs to help write code, `ensure` is a nice addition to your toolbox because of it's focus on testing (we'll cover these tools more in the [Shiny & LLMs section](llms.qmd)).
