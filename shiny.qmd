...
The **New Project Wizard** in RStudio ![](images/rstudio-icon.png){height=20} can be used to create a new Shiny application project: 


![New Shiny app project](images/shiny_new_project_wizard.png){#fig-shiny_new_project_wizard width="75%" fig-align="center"}


New app projects need a name and location: 


![We can also decide whether we want to use Git or `renv`](images/shiny_new_shiny_proj.png){#fig-shiny_new_shiny_proj width="75%" fig-align="center"}
...
The sections below cover additional files to include in your Shiny app.
