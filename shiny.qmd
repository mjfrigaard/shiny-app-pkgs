...
![Git Branch](img/new_branch_ico.png){width='70%'}
...
::: {.callout-caution title="Copy into `projApp`" collapse='false' icon='false'}
...
::: {.callout-caution title="Place in `R/mod_var_input.R`" collapse='true' icon='false'}
...
::: {.callout-caution title="Place in `R/mod_scatter_display.R`" collapse='true' icon='false'}
