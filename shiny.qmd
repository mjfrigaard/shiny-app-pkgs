...
co_box(
  ...
  header = "![Shiny](images/00_index_shiny.png){width='8%'} &emsp; TLDR", fold = TRUE,
  contents = "
...
## Shiny project contents {#sec-shiny-projects}
...
git_margin_box(
  fig_pw = '75%', 
  branch = "02.1_movies-app", 
  repo = 'moviesApp')
```

```{r}
#| label: git_launch_main
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
```{r}
#| label: git_launch_02_movies-app
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
  contents = "launch",
  branch = "02.2_proj-app")
```
...
The `rsconnect/` folder has been removed from the [`02b_proj-app`](https://github.com/mjfrigaard/moviesApp/tree/02b_proj-app) branch.
