...
![](img/00_index_shiny.png){fig-align="right"}
...
co_box(
  ...
  header = "![Shiny](img/00_index_shiny.png){width='8%'} &emsp; TLDR", fold = TRUE,
  contents = "
...
```{r}
#| label: git_box_shinyAppProj_main
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
```{r}
#| label: git_box_shinyAppProj_02_movies-app
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
```{r}
#| label: git_box_shinyAppProj_03_proj-app
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
::: {#fig-01_shiny_movie_reviews_shinyAppProj}

![Movie reviews app](img/01_shiny_movie_reviews_proj_app.png){#fig-01_shiny_movie_reviews_shinyAppProj width="100%" fig-align="center"}
...
The `rsconnect/` folder has been removed from the [`03_proj-app`](https://github.com/mjfrigaard/shinyAppProj/tree/03_proj-app) branch.
