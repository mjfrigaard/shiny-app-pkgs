...
```{r}
#| label: git_box_moviesApp_02_movies-app
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
```{r}
#| label: git_box_moviesApp_03_proj-app
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
::: {#fig-01_shiny_movie_reviews_moviesApp}

![Movie reviews app](img/01_shiny_movie_reviews_proj_app.png){#fig-01_shiny_movie_reviews_moviesApp width="100%" fig-align="center"}
