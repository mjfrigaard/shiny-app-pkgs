...
This chapter briefly reviews programming with Shiny's reactive model and how it differs from regular R programming. Then, I'll cover a few app development best practices *outside* of an R package structure.
...
Properly storing/using utility functions, data, documentation, metadata files, and converting your application code into functions will set you up for success as you transition to storing your app in an R package. 
...
- [x] If you're following along, these callout boxes contain code that should be copied and pasted into your shiny app project.
...
We will place the application in `app.R` from the [Building Web Applications with Shiny](https://rstudio-education.github.io/shiny-course/) course. I’ve chosen to use this app for the following reasons:

1.  **Multiple input types** are collected in the UI 

2. The graph output can be created using a **utility function** 

3. The app loads an **external data** file when it's launched

These elements allow us to explore the features of the Shiny app framework.

### App

::: {.callout-caution title="Place in `app.R`" collapse='true' icon='false'}
...
::: {.callout-caution title="Place in `utils.R`" collapse='true' icon='false'}
...
::: {.callout-caution title="Download `movies.RData`" collapse='true' icon='false'}
...
::: {.callout-caution title="Place at the top of `app.R`" collapse='false' icon='false'}

- [ ] Add the header below to the top of the `app.R` file
...
- [x] If you're following along, these callout boxes contain code and content that should be copied into your shiny app project.
...
::: {.callout-caution title="Place `utils.R` in `R/` folder" collapse='false' icon='false'}

- [ ] Move the `utils.R` file into the `R/` folder in `projApp`:
...
::: {.callout-caution title="Create `www/` folder and download image" collapse='false' icon='false'}

-  [ ] Download the shiny logo ([`shiny.png`](https://raw.githubusercontent.com/rstudio/hex-stickers/main/PNG/shiny.png)) and store it in the `www/` folder. 
...
::: {.callout-caution title="Create `README.md`" collapse='false' icon='false'}

- [ ] Include the content below in the `README.md` file
...
::: {.callout-caution title="Create `DESCRIPTION`" collapse='false' icon='false'}

- [ ] Include the content below in `DESCRIPTION`:
...
::: {.callout-caution title="`R/mod_var_input.R`" collapse='true' icon='false'}
...
::: {.callout-caution title="`R/mod_scatter_display.R`" collapse='true' icon='false'}
...
::: {.callout-caution title="`app.R`" collapse='true' icon='false'}
...
::: {.callout-caution title="Using `renv`" collapse='false' icon='false'}
