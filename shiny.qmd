...
flowchart TD
    ...
    style mod_var_input_ui fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style mod_var_input_server fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style Return fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style XUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style YUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style ZUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style AlphaUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style SizeUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style TitleUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style XServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style YServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style ZServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style AlphaServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style SizeServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style TitleServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
...
flowchart TD
    ...
    style User fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style Display fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style selected_vars fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style mod_scatter_display_ui fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style mod_scatter_display_server fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style mod_var_input_ui fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style mod_var_input_server fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style scatter_plot fill:#333,color:#fff,stroke:#000,stroke-width:2px
    style var_inputs fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style inputs fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style Reactives fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style Title fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
```
...
flowchart LR
    ...
    style Launch fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style VarNS fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style GraphNS fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style VarInpuUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style VarInpuServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style DisplayUI fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style DisplayServer fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style PlotUtil fill:#333,color:#fff,stroke:#000,stroke-width:1px
