...
[Making sure it works]{style="font-size: 1.25em; font-style: italic; color: #02577A;"}
...
test_that("{shinytest2} recording: moviesApp-feature-01", {
  app <- AppDriver$new(name = "moviesApp-feature-01", height = 887, width = 1241) # <1>
...
describe(
  ...
  describe(
    ...
    app <- AppDriver$new(app_dir = system.file("dev", package = "moviesApp"), # <1>
