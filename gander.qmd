...
flowchart TD
    User["User prompt"] --> Gander["gander<br>assembles context"]
    Selection["Selected code"] --> Gander
    EnvSnapshot["R environment<br>data frames, objects"] --> Gander
    Gander --> LLM["LLM via ellmer"]
    LLM --> Insert["Streams into source file"]
