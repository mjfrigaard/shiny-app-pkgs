...
flowchart TD
    ...
    style Selection fill:#e3f2fd,stroke:#1976d2,stroke-width:3px,color:#000
    style EnvSnapshot fill:#e3f2fd,stroke:#1976d2,stroke-width:3px,color:#000
    
    style Insert fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px,color:#000
