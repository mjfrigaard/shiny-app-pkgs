...
This chapter covers using `reactiveValues()` to store reactive values. Determining whether or not to use `reactiveValues()` will depend on the purpose you want it to serve in your application.
