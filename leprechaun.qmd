...
This chapter walks through building a version of the `moviesApp` with the [`leprechaun`](https://leprechaun.opifex.org/#/) framework. The resulting app-package (`lap`) is in the [`16_leprechaun` branch](https://github.com/mjfrigaard/moviesApp/tree/16_leprechaun).
