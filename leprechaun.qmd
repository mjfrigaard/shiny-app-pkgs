...
The `leprechaun` workflow involves a combination of `use_` functions that are combined with [`leprechaun::build()`](https://leprechaun.opifex.org/#/reference/build) to add various functionality to your application. I'll demonstrate three options in the sections below.
...
### Summary of `leprechaun` features
