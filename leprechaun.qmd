...
#| eval: true
co_box(
  color = "b", look = "minimal", size = '1.12', hsize = '1.25',
  header = "TLDR  &emsp; ![](images/leprechaun.png){width='10%'} &emsp; The `leprechaun` framework", 
  fold = FALSE,
  contents = "
<br>
...
This chapter walks through building a version of the `moviesApp` with the [`leprechaun`](https://leprechaun.opifex.org/#/) framework. The resulting app-package (`lap`) is in the [`19_leprechaun` branch](https://github.com/mjfrigaard/moviesApp/tree/19_leprechaun).
...
After checking out the `16_leprechaun` branch, be sure to load, document, and install the application.
...
[^leprechaun-zzz]: [Link to `R/zzz.R`]((https://github.com/mjfrigaard/moviesApp/blob/16_leprechaun/R/zzz.R)) file.
 
[^leprechaun-server]: [Link to `R/server.R`]((https://github.com/mjfrigaard/moviesApp/blob/16_leprechaun/R/server.R)) file.

[^leprechaun-ui]: [Link to `R/ui.R`]((https://github.com/mjfrigaard/moviesApp/blob/16_leprechaun/R/ui.R)) file.

[^leprechaun-assets]: [Link to `R/assets.R`]((https://github.com/mjfrigaard/moviesApp/blob/16_leprechaun/R/assets.R)) file.

[^leprechaun-input-handlers]: [Link to `R/input-handlers.R`]((https://github.com/mjfrigaard/moviesApp/blob/16_leprechaun/R/input-handlers.R)) file.

[^leprechaun-utils]: [Link to `R/leprechaun-utils.R`](https://github.com/mjfrigaard/moviesApp/blob/16_leprechaun/R/leprechaun-utils.R) file.
...
[^leprechaun-inst-run-app]: [Link to `inst/run/app.R`](https://github.com/mjfrigaard/moviesApp/blob/16_leprechaun/inst/run/app.R) file.
