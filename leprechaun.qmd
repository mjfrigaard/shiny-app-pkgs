...
This chapter walks through building a version of the `moviesApp` with the [`leprechaun`](https://leprechaun.opifex.org/#/) framework. The resulting app-package (`lap`) is in the [`18_leprechaun` branch](https://github.com/mjfrigaard/moviesApp/tree/18_leprechaun).
...
git_margin_box(
  contents = "standard",
  fig_pw = '75%', 
  branch = "18_leprechaun", 
  repo = 'moviesApp')
```

After checking out the `18_leprechaun` branch, be sure to load, document, and install the application.
...
[^leprechaun-zzz]: [Link to `R/zzz.R`]((https://github.com/mjfrigaard/moviesApp/blob/18_leprechaun/R/zzz.R)) file.
 
[^leprechaun-server]: [Link to `R/server.R`]((https://github.com/mjfrigaard/moviesApp/blob/18_leprechaun/R/server.R)) file.

[^leprechaun-ui]: [Link to `R/ui.R`]((https://github.com/mjfrigaard/moviesApp/blob/18_leprechaun/R/ui.R)) file.

[^leprechaun-assets]: [Link to `R/assets.R`]((https://github.com/mjfrigaard/moviesApp/blob/18_leprechaun/R/assets.R)) file.

[^leprechaun-input-handlers]: [Link to `R/input-handlers.R`]((https://github.com/mjfrigaard/moviesApp/blob/18_leprechaun/R/input-handlers.R)) file.

[^leprechaun-utils]: [Link to `R/leprechaun-utils.R`](https://github.com/mjfrigaard/moviesApp/blob/18_leprechaun/R/leprechaun-utils.R) file.
...
[^leprechaun-inst-run-app]: [Link to `inst/run/app.R`](https://github.com/mjfrigaard/moviesApp/blob/18_leprechaun/inst/run/app.R) file.
...
#| eval: false 
#| code-fold: false
# in the 18_leprechaun branch of moviesApp
