...
This chapter walks through building a version of the `shinyrPkgs` with the [`leprechaun`](https://leprechaun.opifex.org/#/) framework. The resulting app-package (`lap`) is in the [`23_leprechaun`](https://github.com/mjfrigaard/shinyrPkgs/tree/23_leprechaun) branch.
...
[^leprechaun-3]: [Link to `R/assets.R`]((https://github.com/mjfrigaard/shinyrPkgs/blob/23_leprechaun/R/assets.R)) file.

[^leprechaun-4]: [Link to `R/input-handlers.R`]((https://github.com/mjfrigaard/shinyrPkgs/blob/23_leprechaun/R/input-handlers.R)) file.

[^leprechaun-5]: [Link to `R/leprechaun-utils.R`](https://github.com/mjfrigaard/shinyrPkgs/blob/23_leprechaun/R/leprechaun-utils.R) file.

[^leprechaun-6]: [Link to `R/ui.R`]((https://github.com/mjfrigaard/shinyrPkgs/blob/23_leprechaun/R/ui.R)) file.

[^leprechaun-7]: [Link to `R/server.R`]((https://github.com/mjfrigaard/shinyrPkgs/blob/23_leprechaun/R/server.R)) file.

[^leprechaun-8]: [Link to `R/zzz.R`]((https://github.com/mjfrigaard/shinyrPkgs/blob/23_leprechaun/R/zzz.R)) file.
...
[^leprechaun-9]: [Link to `inst/run/app.R`](https://github.com/mjfrigaard/shinyrPkgs/blob/23_leprechaun/inst/run/app.R) file.
...
[^leprechaun-15]: The same `scatter_plot()` function from `shinyrPkgs` (i.e, imports `.data` from `rlang`)
...
#| eval: false 
#| code-fold: false
# in the 23_leprechaun branch of shinyrPkgs
