...
co_box(
  ...
  header = "![](images/leprechaun.png){width='8%'} &emsp; `leprechaun` framework features", 
  fold = FALSE,
  contents = "<br>
  
- Helper functions for adding modules, js, css, html, etc.
  
- 'Pre-packaged' with UI, server, and standalone app functions
  
- App external resources location in `inst/`
