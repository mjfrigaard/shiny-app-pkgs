...
-   [This chapter](@sec-docker) covers how Docker can simplify setting up your R environment and reduce the "it works on my machine" problem:
    ...
    -   [What is Docker](@sec-what-is-docker) and how does it provide a consistent environment for the application, ensuring it works seamlessly across different computers.

    -   Building a Shiny app-package [inside a Docker image](@sec-dockerfile), which can be launched into a virtual container. 

  
## Continuous Integration and Deployment with GitHub Actions

-   [Introduce how CI/CD](@sec-cicd) can be used to automate processes like styling, linting, testing, and deploying our Shiny app-package.

-   [How GitHub Actions](@sec-gha) can be used in combination with Docker to container-ize *and* deploy our app-package.