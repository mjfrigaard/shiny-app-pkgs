...
Translation: User specifications are often the basis from which functional requirements are derived. 
...
In summary, user specifications and functional requirements work together to ensure that software is both technically sound and user-friendly. User specifications , while functional requirements provide the "how," defining the technical steps necessary to fulfill those needs.
