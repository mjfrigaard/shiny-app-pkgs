...
co_box(
  color = "r",
  fold = FALSE,
  header = "GitHub [`pkgApp`]:[`05-inst`]",
  contents = "
  
  This shiny app project can be found in the `05-inst` branch of the [`pkgApp`](https://github.com/mjfrigaard/pkgApp/tree/05-inst) repo.
...
co_box(
  ...
  header = "GitHub [`pkgApp`]:[`05-inst`]",
  contents = "
  The code for this section was pushed to the  [[`05-inst`](https://github.com/mjfrigaard/pkgApp/tree/05-inst)] branch of the [[`pkgApp`](https://github.com/mjfrigaard/pkgApp)] repo.
