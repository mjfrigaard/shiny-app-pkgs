...
The `inst/` folder plays a special role in R packages, and can be incredibly helpful for app-packages. In the previous chapter we covered including external datasets in the `inst/extdata/` folder, and accessing these files with `system.file()`. 

In this chapter we'll cover how to add external resources (i.e., the files stored in the `www/` folder of your shiny app project) to your shiny app-packages.
