...
After creating your `DESCRIPTION` file with the seven mandatory fields, placing the `.R` files in the `R/` folder, and configuring the project build tools, we're ready to test our app-package ‘functionality’ with the [`devtools` package](https://devtools.r-lib.org/).
...
[<kbd>Ctrl/Cmd</kbd> + <kbd>Shift</kbd> + <kbd>L</kbd>]{style='font-weight: bold; font-size: 0.75em;'} / `devtools::install()`
