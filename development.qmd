...
Let's assume we're continuing with the app project we converted manually in the [previous branch](https://github.com/mjfrigaard/moviesApp/tree/03.1_description)  of `moviesApp` (the files and folders are below).
