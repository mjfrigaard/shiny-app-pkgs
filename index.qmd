...
This resource is currently being revised to include some recent changes in the Shiny development landscape (Positron, AI tools, etc.). While most of the information in the [Introduction](intro.qmd) and [App-packages](app_packages.qmd) sections will remain unchanged, some sections are being written/updated: 
...
##### [Shiny](shiny.qmd)   
  -   Has new diagrams in @sec-shiny-modules and  @sec-shiny-standalone-app-fun   
  
##### [Packages](packages.qmd)   
  - Now includes a @sec-packages-positron-workspaces section   
  
##### [Development](development.qmd)  
  - Covers the differences between RStudio and Positron when calling @sec-dev-install    
  
##### [Dependencies](dependencies.qmd)
  -   Includes new diagrams and a new section on managing dependencies with [`renv`](https://rstudio.github.io/renv/articles/renv.html).    
  
##### [Documentation](document.qmd)    
  -   Includes new diagrams in @sec-intro-roxygen2 and @sec-document-app-functions   
  
##### [Testing](tests.qmd)   
  -   Now includes @sec-test-tools-help and @sec-test-logger   
    
##### [Deployment](deploy)   
  -   Better GitHub Actions examples for @sec-gha-shiny and @sec-gha-shiny-docker     
  -   Expanded @sec-pkgdown example     

##### [Frameworks](frameworks.qmd)     
  -   @sec-golem app rebuilt using version 0.5.1          
  -   @sec-leprechaun app built using version 1.0.0.9001          
  -   @sec-rhino app built using version 1.10     
...
##### [Shiny Tools](tools.qmd)      
-   I've added a [Shiny Tools](tools.qmd) section:
    -   @sec-shiny-assist   
    -   @sec-shiny-ellmer   
    -   @sec-shiny-chores  (*in development*)
    -   @sec-shiny-gander (*in development*)
