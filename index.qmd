...
co_box(
  color = "y",
  header = "Caution",
  contents = "This book is under active development. The contents are subject to change.",
...
[Shiny App-Packages covers how to create a Shiny application as an R package.]{style='font-size: 1.25em; font-weight: bold;'}

:::

![](images/shinyap_logo_white.png){class="cover" width="340" fig-align="right"}
...
The chapters in this book serve as a *"a Shiny developers' guide to a collection of computational tools and commands for creating shiny app-packages"* [^toolchain-walkthrough-3]
