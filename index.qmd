...
![](images/sap_icon.png){class="cover" width="380" fig-align="right"}
...
co_box(
  color = "b",
  header = "URLs for the book", 
  size = "0.95", 
  hsize = "1.25",
  contents = "
- **[https://bit.ly/ShinyAppPkgs](https://bit.ly/ShinyAppPkgs)**: is a short URL for the Shiny App-Packages book  
  - GitHub location: [https://github.com/mjfrigaard/shiny-app-pkgs/](https://github.com/mjfrigaard/shiny-app-pkgs/)
...
co_box(
  color = "b",
  header = "Accessing the code/apps/examples", 
  size = "0.95", 
  hsize = "1.25",
  contents = "
In an effort to make each section accessible and easy to follow, I've created an R package for the code examples: **[https://mjfrigaard.github.io/shinypak/](https://mjfrigaard.github.io/shinypak/)**
  
  - Install the package using `pak` (or `remotes`):
  ...
  - Load the package and launch an app/chapter
...
**[https://mjfrigaard.github.io/shinypak/](https://mjfrigaard.github.io/shinypak/)**

Sections also include the code for installing, loading, and launching applications using `shinypak`: 

<blockquote> 

"*Install the [`shinypak` package](https://mjfrigaard.github.io/shinypak/articles/getting-started.html) package to easily launch the applications:*"
...
![shinypak::launch('09.2_inst-bslib')](https://raw.githubusercontent.com/mjfrigaard/shinypak/main/man/figures/launch_app_pkg.gif){width="100%" fig-align="center"}
