...
The code files for each chapter are stored in [GitHub repository](https://github.com/mjfrigaard/shinyrPkgs). Major code changes are stored in branches. Whenever a new branch is used, you'll see the **Git Branch** icon with a link to the repo/branch in the margin.
