...
- **[https://github.com/mjfrigaard/shiny-app-pkgs/](https://github.com/mjfrigaard/shiny-app-pkgs/)**: is the URL for the Shiny App-Packages book
  ...
  - GitHub location (R package): [https://github.com/mjfrigaard/shiny-app-pkgs/](https://github.com/mjfrigaard/shiny-app-pkgs/)
...
- **[https://mjfrigaard.github.io/shinypak/](https://mjfrigaard.github.io/shinypak/)**: is now the R package for accessing the applications in Shiny App-Packages book  
  \`\`\`r
...
Each section also includes code to install the `shinypak` for downloading and launching applications: 
