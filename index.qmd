...
[Mastering Shiny](https://mastering-shiny.org/) is an excellent introduction to the captivating world of Shiny and provides a foundation of best practices for building applications. R packages are [covered in Mastering Shiny](https://mastering-shiny.org/scaling-packaging.html), and while this chapter is a great place to start, I think to fully understand and appreciate the benefits of developing a Shiny app as a package, I wanted an example with most (or some) of the development tools.
