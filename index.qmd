...
##### [Dependencies](dependencies.qmd)
  -   New diagrams and a new section on managing dependencies with [`renv`](https://rstudio.github.io/renv/articles/renv.html).    
  
##### [Documentation](document.qmd)    
  -   New diagrams in @sec-intro-roxygen2 and @sec-document-app-functions   
  
##### [Testing](tests.qmd)   
  -   Now includes @sec-test-tools-help and @sec-test-logger   
    
##### [Deployment](deploy)   
  -   Updated GitHub Actions examples for @sec-gha-shiny and @sec-gha-shiny-docker     
