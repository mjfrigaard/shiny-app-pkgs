...
![](images/shiny-hex.png){fig-align="left" width="150"}
...
##### [App-packages](app_packages.qmd)      
-   The [Documentation](document.qmd) section needs to be updated with the latest changes to the `roxygen2` package.
    -   @sec-doc    
    
##### [Shiny LLM Tools](tools.qmd)      
-   I'm still working on the `btw` section of the [Shiny LLM Tools](tools.qmd) section:
    -   @sec-shiny-btw 
...
![](images/launch_02.3_app.gif){width="100%" fig-align="center"}
