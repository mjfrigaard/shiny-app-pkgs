...
I starting writing this resource after multiple encounters with Shiny developers who had create impressive, complex apps but struggled converting them into R packages, a problem which often let to delays in moving their applications into a production environment.

::: {style='font-size: 1.05em; font-weight: bold; font-style: italic; color: #282b2d;'}

Did you read [Mastering Shiny](https://mastering-Shiny.org/) and want to learn more about package development?

:::

[Mastering Shiny](https://mastering-shiny.org/) is an excellent introduction to the captivating world of Shiny and provides a foundation of best practices for building applications. [R packages are covered in Mastering Shiny](https://mastering-shiny.org/scaling-packaging.html), and I found this chapter was a great place to start. However, to fully understand and appreciate the benefits of developing Shiny apps in R packages, I wanted a resource that includes a full tour of the package development tools (loading, testing, deploying, etc.).
...
[`golem`](https://thinkr-open.github.io/golem/) is the ‘*opinionated framework for building production-grade Shiny applications*’ introduced in [Engineering Production-Grade Shiny Apps](https://engineering-shiny.org/) (or EPGSA). `golem` offers a robust and standardized way to build, maintain, and deploy production-grade Shiny apps. Whether it's due to the learning curve, overhead, dependencies, legacy code, or your particular deployment constraints, `golem` might not be the right fit for your situation. 
