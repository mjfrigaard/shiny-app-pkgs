...
Regardless of the method we use to start our app-package, if we want it to be ‘functional’, we need to install the [`devtools` package](https://devtools.r-lib.org/).
...
## Functions as [habits]{style="font-weight: bold; font-size: 1.0em; color: #772953"}
