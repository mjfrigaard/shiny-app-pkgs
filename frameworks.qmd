...
This section covers three popular Shiny frameworks: [`golem`](https://thinkr-open.github.io/golem/index.html), [`leprechaun`](https://leprechaun.opifex.org/#/), and [`rhino`](https://github.com/Appsilon/rhino). These frameworks provide structure, modularity, and encourage better development practices, but each their own philosophy, strengths, and ideal use-case.
