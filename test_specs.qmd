...
[What Should I Test (And How Should I Test It)?]{style="font-size: 1.40em; font-style: italic; color: #02577A;"}
...
### [`describe()`]{style="font-size: 0.90em;"} a feature 
...
### Confirm [`it()`]{style="font-size: 0.90em;"} with a test
...
co_box(
  color = "g",
  look = "default", hsize = "1.15", size = "1.10",
  header = "Recap: Test Specigications",
  contents = "
