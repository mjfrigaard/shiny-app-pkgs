...
#| results: asis
#| echo: false
co_box(color = "g", fold = TRUE, size = "1.10", hsize = "1.15",
...
1. Modules and utility function were easily created with [`add_module()`](https://thinkr-open.github.io/golem/reference/add_module.html) and [`add_utils()`](https://thinkr-open.github.io/golem/reference/file_creation.html)   
2. The [`bslib`](https://rstudio.github.io/bslib/) layout functions and the [`thematic`](https://rstudio.github.io/thematic/) theme were added to [`app_ui()` and `golem_add_external_resources()`](https://github.com/mjfrigaard/sap/blob/23_golem/R/app_ui.R)      
3. The module server logic was added to [`app_server()`](https://github.com/mjfrigaard/sap/blob/23_golem/R/app_server.R)    
4. The `golem` hex image was moved added [`inst/app/www/`](https://github.com/mjfrigaard/sap/tree/23_golem/inst/app/www)     
5. I downloaded the `movies.RData` file into [`inst/extdata/`](https://github.com/mjfrigaard/sap/tree/23_golem/inst/extdata), then created [`data-raw/movies.R`](https://github.com/mjfrigaard/sap/tree/23_golem/data-raw/movies.R) and created [`data/movies.rda`](https://github.com/mjfrigaard/sap/tree/23_golem/data/).     
...
7. Added the `test_logger()` function to [`R/utils_tests.R`](https://github.com/mjfrigaard/sap/blob/23_golem/R/utils_tests.R).   
8. Revised the unit tests and moved the system tests to [`vignettes/shinytest2.Rmd`](https://github.com/mjfrigaard/sap/blob/23_golem/vignettes/shinytest2.Rmd).   
