...
This chapter walks through building a version of the `sap` with the [`golem` framework](https://thinkr-open.github.io/golem/). The resulting app-package (`gap`) is in the [`27_golem` branch](https://github.com/mjfrigaard/sap/tree/27_golem).
...
After checking out the `27_golem` branch, be sure to load, document, and install the application.
