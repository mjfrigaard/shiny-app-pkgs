...
- A variety of helper functions for creating modules, utility functions, js, css, etc.
  
- Consistent naming conventions (`mod_`, `fct_`, `utils_`, etc.)
  
- Apps come 'pre-packaged' with UI, server, and standalone app functions
  
- External resources located in `inst/app`
