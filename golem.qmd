...
flowchart TD
    ...
    style User fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px,font-size:18px
    style Display fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px,font-size:18px

    style mod_scatter_display_ui fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px,rx:3,ry:3,font-size:13px
    style mod_scatter_display_server fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px,rx:3,ry:3,font-size:13px
    style mod_var_input_server fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px,rx:3,ry:3,font-size:14px
    style mod_var_input_ui fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px,rx:3,ry:3,font-size:14px
    style mod_aes_input_server fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px,rx:3,ry:3,font-size:14px
    style mod_aes_input_ui fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px,rx:3,ry:3,font-size:14px

    style AesReactives fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff,font-size:14px
    style VarReactives fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff,font-size:14px
    style selected_vars fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff
    style selected_aes fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff
    style var_inputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff
    style aes_inputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff
    style inputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:2px,color:#fff

    style scatter_plot fill:#333,color:#FFF,stroke:#000,stroke-width:2px,rx:10,ry:10
