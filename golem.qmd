...
This chapter walks through building a version of the `moviesApp` with the [`golem` framework](https://thinkr-open.github.io/golem/). The resulting app-package (`gap`) is in the [`17_golem` branch](https://github.com/mjfrigaard/moviesApp/tree/17_golem).
...
After checking out the `17_golem` branch, be sure to load, document, and install the application.
...
#| eval: false 
#| code-fold: false
# in the 17_golem branch of moviesApp
