...
![](img/11_tests_code_coverage_module_01.png){width="90%" fig-align='center'}
...
This executes the code used build the graph in `mod_scatter_display_server()` and increases out test code coverage. 

![](images/11_tests_code_coverage_module_02.png){width="100%" fig-align='center'}
...
![Passing `plot` to `print()` will send the graph to the **Plots** pane](images/11_tests_print_plot_module.png){width="90%" fig-align='center'}
