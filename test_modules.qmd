...
[Integration Testing For Smooth Operations]{style="font-size: 1.25em; font-style: italic; color: #02577A;"}
...
![](img/11_tests_code_coverage_module_02.png){width="90%" fig-align='center'}
...
![Passing `plot` to `print()` will send the graph to the **Plots** pane](img/11_tests_print_plot_module.png){width="90%" fig-align='center'}
