...
flowchart TD
    ...
    style Inputs fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style React fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style Output fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style Variables fill:#f5f5f5,stroke:#999,stroke-width:1px
    style Aesthetics fill:#f5f5f5,stroke:#999,stroke-width:1px
    style Display fill:#f5f5f5,stroke:#999,stroke-width:1px
    style var_input fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style aes_input fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style plot_title fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style var_inputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style aes_inputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style inputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style output fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
...
flowchart 
    ...
    style VarModule fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style AesModule fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style GraphDisplay fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
    style VarInputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style AesInputs fill:#7fd9c7,stroke:#4CBB9D,stroke-width:1px,color:#fff
    style ScatterDiplay fill:#4CBB9D,stroke:#2d8a7a,stroke-width:1px,color:#fff
