...
Docker containers are like individual, self-contained mini-kitchens containing appliances, ingredients, and utensils. Each mini-kitchen can operate independently in the building, regardless of what's happening in the others. Docker images represent different recipes for software applications.[^docker-not-vm]
