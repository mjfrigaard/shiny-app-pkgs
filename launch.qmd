...
## [`app.R`]{style="font-size: 0.95em"} ([`07_roxygen2`]{style="font-size: 0.95em"} branch)
...
```{r}
#| label: git_margin_box_shinyAppPkg_07_roxygen2
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
...
![`app.R` in `07_roxygen2` branch](images/launch_no_run_app_button.png){#fig-launch_no_run_app_button width=100%}

No **Run App** icon in `app.R` of `07_roxygen2` branch
:::
...
![`runApp()` with `07_roxygen2` branch](images/launch_loadsupport_error_run_app.png){#fig-launch_loadsupport_error_run_app width=100%}

Calling `runApp()` in the **Console** of `07_roxygen2` branch
:::
