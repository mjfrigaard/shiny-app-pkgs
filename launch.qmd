...
#### [In `moviesApp`]{style="font-size: 0.85em"}
...
### [`options`]{style="font-size: 0.95em"}
...
## [`movies_app()`]{style="font-size: 0.95em"} {#sec-launch-standalone-app-function}
...
```{r}
#| label: git_box_launch_10_launch-app
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
