...
[Successfully launching your app from your package]{style="font-size: 1.25em; font-style: italic; color: #02577A;"}
...
1 directory, 6 files
```
1. `movies_app()` standalone function in `R/` folder
...
The warning in the **Console** is telling us `loadSupport()` has detected that `moviesApp` is a package, but it's still sourcing the `R/` subdirectory.[^load-support-shiny-chap]
...
:::: {.callout-note collapse="false" appearance="default" title='shinyApp()'}
...
:::: {.callout-note collapse="false" appearance="default" title='shinyAppDir()'}
...
:::: {.callout-note collapse="false" appearance="default" title="runApp()"}
...
### [`options`]{style="font-size: 0.90em"} argument 
...
### [`shinyViewerType`]{style="font-size: 0.90em"} 
...
### Updated [`movies_app()`]{style="font-size: 0.90em"} {#sec-launch-standalone-app-function}
...
### [`!interactive() == TRUE`]{style="font-size: 0.85em"} 

[Non-interactive behaviors]{style="font-size: 1.20em"} 
...
### [`pkgload`]{style="font-size: 0.90em"} {.unnumbered}
