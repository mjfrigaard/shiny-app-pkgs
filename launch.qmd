...
![`app.R` in `05_roxygen2` branch](img/06_app_roxygen_no_runApp_icon.png){#fig-06_app_roxygen_no_runApp_icon width=100%}
...
![`runApp()` with `05_roxygen2` branch](img/06_app_roxygen2_runApp_console.png){#fig-06_app_roxygen2_runApp_console width=100%}
