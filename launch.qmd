...
### [`shinyApp()`]{style="font-size: 0.95em"} {#sec-shiny-app}
...
### [`shinyAppDir()`]{style="font-size: 0.95em"} {#sec-shiny-app-dir}
...
### [`runApp()`]{style="font-size: 0.95em"} {#sec-run-app}
...
You can view a deployed version of this application [here.](https://mjfrigaard.shinyapps.io/moviesApp-launch/)
