...
![`app.R` in `main` branch](img/06_app_pkg_imports_runApp_icon.png){#fig-05_app_main_runApp_icon width=100%}
...
![Calling `runApp()` in `main`](img/06_app_pkg_imports_runApp_console.png){#fig-06_app_pkg_imports_runApp_console width=100%}
...
You can view a deployed version of this application [here.](https://mjfrigaard.shinyapps.io/shinyap-05_launch-app/)
