...
![`app.R` in `main` branch](img/08_app_pkg_imports_runApp_icon.png){#fig-05_app_main_runApp_icon width=100%}
...
![Calling `runApp()` in `main`](img/08_app_pkg_imports_runApp_console.png){#fig-06_app_pkg_imports_runApp_console width=100%}
...
![`app.R` in `05_roxygen2` branch](img/08_app_roxygen_no_runApp_icon.png){#fig-06_app_roxygen_no_runApp_icon width=100%}
