...
This chapter will pick up where we left off with the [`05_roxygen2`](https://github.com/mjfrigaard/moviesApp/tree/05_roxygen2)  branch of  `moviesApp`.
...
#### [`Imports`]{style="font-size: 1.05em"} {#sec-pkg-imports-description}
...
#### [`pkg::fun()`]{style="font-size: 1.05em"} {#sec-depends-pkg-fun-syntax}

Refer to add-on package functions using `pkg::fun()` syntax in the code below `R/`.  

#### [`@importFrom`]{style="font-size: 1.05em"} {#sec-depends-import-from}
...
#### [`@import`]{style="font-size: 1.05em"} {#sec-depends-import}
...
- Place the `@importFrom pkg fun` tag directly above the code using the add-on function.[^use-import-from]

***Should I be using `@importFrom` or `@import` from?***

- Prefer using `@importFrom` over `@import`[^r-ext-imports] [^r-pkgs-imports]
