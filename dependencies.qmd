...
We will use the [`05_roxygen2`](https://github.com/mjfrigaard/shinyAppPkg/tree/05_roxygen2)  branch of  `shinyAppPkg` from the end of the previous chapter. Below is a folder tree of its contents:
