...
![`roxygen2` does not connect the `NAMESPACE` to the `DESCRIPTION`](img/05_dependencies_roxygen2_no_connect_desc.png){#fig-roxygen2_connects width='65%' align='center'}
