...
In order for `shinyAppPkg` to work, users needs to have access to any of the add-on packages that are called in the code below `shinyAppPkg/R/`. Knowing [when, why, how and what happens]{style="font-weight: bold;"} to imports is important because it helps you decide how to fit these habits into your package development workflow. 
