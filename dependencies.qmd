...
## Your package [`NAMESPACE`]{style="font-size: 1.05em"}
...
Or by checking any of the functions in `pkgApp` with `?function`. 
...
Seeing all three functions execute without any errors never gets old!
...
[Wait, what?]{style="font-weight: bold; font-style: italic; font-size: 1.0em; color: #772953"}
...
-   [`R/movies_ui.R`]{style="font-size: 1.10em"}
...
::: {#fig-dependencies_movies_app}
![`pkgApp::movies_app()`](img/dependencies_movies_app.png){#fig-dependencies_movies_app width='100%' fig-align='center'}
...
The code for the next section is in the  [[`03_dependencies`](https://github.com/mjfrigaard/pkgApp/tree/03_dependencies)] branch of the [[`pkgApp`](https://github.com/mjfrigaard/pkgApp)] repo.
