...
[Managing what goes in and comes out]{style="font-size: 1.25em; font-style: italic; color: #02577A;"}
...
#### [`Depends`]{style="font-size: 1.05em"} {#sec-pkg-depends-description}
...
#### [`Suggests`]{style="font-size: 1.05em"} {#sec-pkg-suggests-description}
...
#### [`@import shiny`]{style="font-size: 1.05em; font-weight: bold;"} {.unnumbered}
...
#### [`@importFrom rlang .data`]{style="font-size: 1.05em; font-weight: bold;"} {.unnumbered}
...
![`movies_app()` works](images/dep_exported_app_fun.png){#fig-03_dependencies_namespace_import_shiny width='100%' align='center'}
