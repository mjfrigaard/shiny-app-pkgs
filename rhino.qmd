...
This chapter briefly describes a version of `moviesApp` built using [`rhino`](https://appsilon.github.io/rhino/). The resulting app (`rap`) is in the [`24_rhino`](https://github.com/mjfrigaard/moviesApp/tree/24_rhino) branch. 
...
`rhino` takes a novel and innovative approach to developing Shiny applications (and covering all the ways they differ from app-packages is beyond the scope of this book). Feel free to review the code in the [`24_rhino` branch](https://github.com/mjfrigaard/moviesApp/tree/24_rhino) for a better understanding of how the `box` modules are structured and used within the `ui` and `server`. 
