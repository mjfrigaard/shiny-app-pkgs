...
This chapter briefly describes a version of `moviesApp` built using [`rhino`](https://appsilon.github.io/rhino/). The resulting app (`rap`) is in the [`24_rhino` branch](https://github.com/mjfrigaard/moviesApp/tree/24_rhino). 
