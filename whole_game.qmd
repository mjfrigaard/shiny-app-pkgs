...
[^whole-game-month-app]: I've stored the code for this application in the [`01_whole-app-game`](https://github.com/mjfrigaard/shinyAppPkgs) branch of the `shinyAppPkgs` repository (to avoid confusing it with the *actual* application repo for this chapter).
