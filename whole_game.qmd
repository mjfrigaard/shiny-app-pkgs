...
[^whole-game-month-app]: I've stored the code for this application in the [`01_whole-app-game`](https://github.com/mjfrigaard/shinyrPkgs) branch of the `shinyrPkgs` repository (to avoid confusing it with the *actual* application repo for this chapter).
