...
flowchart TD
  ...
  style workflow fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
  style event fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
...
flowchart
  ...
  style workflow fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
  style event fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style Jobs fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
```
...
flowchart
  ...
  style event fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style Jobs fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
  style VM fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
  style runner01 fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
  style runner02 fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
```
...
flowchart
  ...
  style runner01 fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
  style runner02 fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
  style action01a fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style action01b fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style action02a fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style action02b fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style step01a fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style step02a fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
```
...
flowchart TD
  ...
  style Push fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
  style Shiny fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
```
...
flowchart TD
  ...
  style Push fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
  style Shiny fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
  style ubuntu fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
  style Env fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
```
...
flowchart TD
  ...
  style Shiny fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
  style ubuntu fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
  style PAT fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style Checkout fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style SetupPandoc fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style SetupR fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style SetupRenv fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
```
...
flowchart TD
  ...
  style SetupR fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style SetupRenv fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style InstallRsconnect fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style Auth fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
  style Deploy fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
```
...
In this `app.R`, the `launch_app()` call specifies `app = 'ggp2'` to select which application to launch, and `mode = "run"` to use blocking mode—appropriate for GitHub Actions since the deployment environment is non-interactive. The `test.mode = FALSE` option disables test mode in the deployed environment.
