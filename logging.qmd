...
We're going to start logging the behaviors of our app in the `inst/tidy-movies` folder. The architecture of this application has been updated to include the two new input modules (review this app in @sec-resources-inst-tidy-movies-app):
