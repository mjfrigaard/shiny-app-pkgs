...
This chapter walks through building a version of the `shinyAppPkgs` with the [`charpente`](https://rinterface.github.io/charpente/) framework. The resulting app-package (`cap`) is in the [`24_charpente`](https://github.com/mjfrigaard/shinyAppPkgs/tree/24_charpente) branch.
