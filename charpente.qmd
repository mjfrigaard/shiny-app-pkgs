...
This chapter walks through building a version of the `shinyrPkgs` with the [`charpente`](https://rinterface.github.io/charpente/) framework. The resulting app-package (`cap`) is in the [`24_charpente`](https://github.com/mjfrigaard/shinyrPkgs/tree/24_charpente) branch.
