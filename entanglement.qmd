...
Updating shinyrPkgs documentation
...
`attachment::att_amend_desc()` will automatically create a [`dev/` folder](https://github.com/mjfrigaard/shinyrPkgs/tree/17_code-tools/dev) with a YAML configuration file:
