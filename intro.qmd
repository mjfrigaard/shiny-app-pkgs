...
[Any R shiny app project you share with others belongs in an R package.]{style='font-size: 1.15em; font-style: italic; font-weight: bold; color: #FF5200;'}

I could extend this statement to *'any R project'*, but it's especially true for shiny applications destined for deployment in a production environment. 
...
co_box(
  ...
  contents = "Julia Silge gave an excelent description of what it means to put something into production in [her SatRdays London talk]((https://youtu.be/53-x5OFMGjA?t=1411)), 'What is 'production' anyway? MLOps for the curious.'"
)
```
...
[Great R packages define and solve common problems.]{style='font-size: 1.15em; font-style: italic; font-weight: bold; color: #FF5200;'} 
