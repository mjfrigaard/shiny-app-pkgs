...
-   @sec-cicd covers continuous integration (CI) / continuous deployment (CD) for Shiny app-packages.

-   @sec-code-tools introduces tools to help keep your code base properly formatted and error free.
