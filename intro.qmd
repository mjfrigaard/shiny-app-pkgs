...
This book was written because the transition from building Shiny applications to writing R packages is complicated and involves a shift in focus, skill set, and development practices. I began to notice a gap in knowledge among Shiny developers and believe it comes from consulting two common resources people encounter when looking to build shiny applications: [Mastering Shiny](https://mastering-shiny.org/) and [Engineering Production-Grade Shiny Apps](https://engineering-shiny.org/).
