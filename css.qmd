...
App-packages are essentially bundles of various components, including UI elements, server logic, and data. The inclusion of CSS in these packages serves several purposes:
...
[^img-external]: I've also included the Shiny icon using `shiny::img()`, `addResourcePath()`, and `system.file()` we covered back in @sec-external-add-resource-path. 
...
![Internal CSS in the UI with `tags$style()`](images/internal_css.png)
...
![CSS custom header](images/css_header.png){width='90%'}
...
![CSS custom](images/css_sidebar.png){width='90%'}
...
![CSS external file](images/external_file_css.png){width='90%'}
...
Integrating CSS into your R packages containing Shiny apps opens a world of possibilities for customization and enhancement. By understanding the basics of CSS and applying best practices, you can significantly improve the visual appeal and user experience of your Shiny applications. Remember, the goal is not just to make your apps work well but also to make them look great and provide an engaging experience for the end-user.
