...
## roxygen2 intro {#sec-intro-roxygen2}
...
flowchart TD
  ...
  style X3 fill:#89D6FB,stroke:#000000,rx:1,ry:1;
  style X4 fill:#89D6FB,stroke:#000000,rx:1,ry:1;
  style X5 fill:#8dd38d,stroke:none,rx:10,ry:10;
  style X6 fill:#8dd38d,stroke:none,rx:10,ry:10;
```
...
%%{init: {'theme': 'base', 'themeVariables': { 'fontFamily': 'monospace', 'primaryColor': '#33a02c', 'edgeLabelBackground':'#FFFFFF'}}}%%
flowchart 
    input(input module) --> seealso[<code>@seealso</code>] -->  display(display module)
    
  style input fill:#8dd38d,stroke:none,rx:10,ry:10;
  style display fill:#8dd38d,stroke:none,rx:10,ry:10;
  style seealso fill:#89D6FB,stroke:#000000,rx:1,ry:1;
```
