...
flowchart TD
    ...
    subgraph Graph["<strong>Display Modules</strong>"]
    ...
    subgraph Vars["<strong>Input Modules</strong>"]
...
Below are roxygen2 documentation examples for the variable input module. See the [full documented module](https://github.com/mjfrigaard/sap/blob/05_roxygen2/R/mod_var_input.R) on GitHub for complete implementation with `@examples`.
