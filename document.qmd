...
The current state of `moviesApp` is stored in the [`06b_devtools`](https://github.com/mjfrigaard/moviesApp/tree/06b_devtools) branch. 
...
![`@family` in `mod_scatter_display_ui()`](images/doc_family.png){fig-align='center'}

![`@seealso` in `mod_scatter_display_server()`](images/doc_usage_seealso.png){fig-align='center'}
...
```{r}
#| label: git_box_pkgApp_07_roxygen2
#| echo: false
#| results: asis
#| eval: true
git_margin_box(
