...
co_box(
  ...
  header = "![](img/roxygen2.png){width='10%'} &emsp; TLDR", 
  fold = TRUE,
  contents = "
...
The current state of `shinyAppPkg` is stored in the [`main` branch](https://github.com/mjfrigaard/shinyAppPkg/tree/main) (identical to the [`06_create-package` branch of `shinyAppProj`](https://github.com/mjfrigaard/shinyAppProj/tree/06_create-package)). 
...
![`@tag` links to `.Rd` file](img/04_rox2_tag_rd_link.png){#fig-04_rox2_tag_rd_link width='90%' fig-align='center'}
