...
![`roxygen2` tag syntax in `.Rd` file](images/dox_rox2_tag_rd_link.png){width='100%' fig-align='center'}
...
`scatter_plot()` in `mod_scatter_display_server()` (a) and `@seealso` in `scatter_plot()` (b)
:::
...
![`launch_app()`](images/doc_movies_app.png){width='90%' fig-align='center'}
