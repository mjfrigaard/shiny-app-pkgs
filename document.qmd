...
[^main-06_create-package]: The [`main`](https://github.com/mjfrigaard/moviesApp/tree/main) branch of `moviesApp` is identical to the [`06_create-package`](https://github.com/mjfrigaard/moviesApp/tree/06_create-package)  branch of `moviesApp`.
