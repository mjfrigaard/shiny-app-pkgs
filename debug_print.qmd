...
flowchart LR
    ...
    style Insert fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style Exec fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style Print fill:#7fd9c7,color:#fff,stroke:#4CBB9D,stroke-width:1px
    style Issue fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style Mod fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
```
...
flowchart LR
    ...
    style Issue fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style Mod fill:#4CBB9D,color:#fff,stroke:#2d8a7a,stroke-width:2px
    style Reactive fill:#e8f4f1,stroke:#4CBB9D,stroke-width:2px
```
