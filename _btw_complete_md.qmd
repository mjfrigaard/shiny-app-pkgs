...
[sap]{style="font-weight: bold; font-size: 2.00em;"} 

> Demo Shiny app-package showcasing `btw` integration and app-package best practices

[Overview]{style="font-weight: bold; font-size: 1.75em;"}  
...
[Purpose]{style="font-weight: bold; font-size: 1.75em;"}   
...
[Architecture & Design]{style="font-weight: bold; font-size: 1.75em;"}  

[App-Package Structure]{style="font-weight: bold; font-size: 1.60em;"}   
...
[Shiny Modules Pattern]{style="font-weight: bold; font-size: 1.60em;"}    
...
[Entry Points]{style="font-weight: bold; font-size: 1.60em;"}   
...
[btw Integration]{style="font-weight: bold; font-size: 1.60em;"}   
...
[Data]{style="font-weight: bold; font-size: 1.75em;"}   

[movies Dataset]{style="font-weight: bold; font-size: 1.60em;"}    
...
[Development Workflow]{style="font-weight: bold; font-size: 1.75em;"}    

[Setup]{style="font-weight: bold; font-size: 1.60em;"}   
...
[Common Tasks]{style="font-weight: bold; font-size: 1.60em;"}    
...
[Code Conventions]{style="font-weight: bold; font-size: 1.60em;"}    
...
[Testing the App]{style="font-weight: bold; font-size: 1.60em;"}   
...
[Technical Details]{style="font-weight: bold; font-size: 1.75em;"}   

[Dependencies]{style="font-weight: bold; font-size: 1.60em;"}    
...
[Directory Structure]{style="font-weight: bold; font-size: 1.60em;"}    
...
[Key Components]{style="font-weight: bold; font-size: 1.60em;"}    
...
[Resources]{style="font-weight: bold; font-size: 1.75em;"}    
