...
As applications grow in complexity, it's highly likely you'll encounter bugs or errors during development. Fortunately, both RStudio ![](images/rstudio-icon.png){height=20} and Positron ![](images/positron.png){height=20} come with powerful interactive debuggers, which help us identify, analyze, and fix errors in our code.[^debug-define] 
