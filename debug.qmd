...
So far this book has covered the contents of an R package when it contains a basic, functional Shiny application. However, as applications grow in complexity, it's highly likely you'll encounter bugs or errors during development. Fortunately, both RStudio and Positron come with powerful interactive debuggers, which help us identify, analyze, and fix errors in our code.[^debug-define] Consider the diagram below that illustrates the reactive inputs in our application: 
