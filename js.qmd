...
R is often developed in IDEs like [Posit Workbench](https://posit.co/products/enterprise/workbench/) or [Jupyter Notebooks](https://jupyter.org/), while JavaScript is commonly used with text editors such as [Visual Studio Code](https://code.visualstudio.com/), [WebStorm](https://www.jetbrains.com/webstorm/), and along with tools like [Babel](https://babeljs.io/) and [Webpack](https://webpack.js.org/) for modern JS development.
...
## JS App-Packages with `charpente`
