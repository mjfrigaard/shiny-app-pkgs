...
If the contents in description for a function requires more complicated formatting than a single paragraph (i.e., multiple paragraphs, lists, etc.), you can use the `@description` with `@details` tag:
...
The `roxygen2` documentation for `pkgApp` is saved in the [`02-roxygen` branch](https://github.com/mjfrigaard/pkgApp/tree/02-roxygen). The new app-package contents are below: 
